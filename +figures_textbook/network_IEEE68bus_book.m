classdef network_IEEE68bus_book < power_network
% モデル  ：IEEE68母線モデル(テキストの巻末の表のパラメータに設定)
...
%　出力　：`power_network`クラスの変数
    ...
    methods
        function obj = network_IEEE68bus_book()
        omega0 = 60*2*pi;
        ...
        machinery{ 1:12,'M'} = machinery{ 1:12,'M'}/2;
        machinery{13:16,'M'} = machinery{13:16,'M'}/4;
        machinery{[13,16],{'D','Xq','Xd_prime'}} = machinery{[13,16],{'D','Xq','Xd_prime'}} * diag([1/2,2,2]);
