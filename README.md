...
本リポジトリは関連参考文献(URL)ないで扱うサンプルコードおよび、テキスト内のグラフ作成に用いたコードをまとめています。

グラフ作成には我々、石崎研究室で開発している、GUILDAを利用しています。
...
- figure_textbook
  - テキスト内のグラフ作成のサンプルコード
  - このフォルダ内のコードは一部のファイルを除き、全てがGUILDAのクラスを用いて作成されています。
